...
category: 基础数据
type: api
source: https://tushare.pro/document/2?doc_id=26
markdown: https://tushare.pro/wctapi/documents/26.md
updated: 2026-09-15
api: trade_cal
---
...
> **接口：** `trade_cal` · [官方文档](https://tushare.pro/document/2?doc_id=26)
