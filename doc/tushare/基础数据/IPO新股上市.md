...
category: 基础数据
type: api
source: https://tushare.pro/document/2?doc_id=123
markdown: https://tushare.pro/wctapi/documents/123.md
updated: 2026-09-15
api: new_share
---
...
> **接口：** `new_share` · [官方文档](https://tushare.pro/document/2?doc_id=123)
