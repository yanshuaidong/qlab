...
category: 基础数据
type: api
source: https://tushare.pro/document/2?doc_id=194
markdown: https://tushare.pro/wctapi/documents/194.md
updated: 2026-09-15
api: stk_rewards
---
...
> **接口：** `stk_rewards` · [官方文档](https://tushare.pro/document/2?doc_id=194)
