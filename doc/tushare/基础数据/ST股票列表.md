...
category: 基础数据
type: api
source: https://tushare.pro/document/2?doc_id=397
markdown: https://tushare.pro/wctapi/documents/397.md
updated: 2026-09-15
api: stock_st
---
...
> **接口：** `stock_st` · [官方文档](https://tushare.pro/document/2?doc_id=397)
