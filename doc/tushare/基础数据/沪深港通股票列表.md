...
category: 基础数据
type: api
source: https://tushare.pro/document/2?doc_id=398
markdown: https://tushare.pro/wctapi/documents/398.md
updated: 2026-09-15
api: stock_hsgt
---
...
> **接口：** `stock_hsgt` · [官方文档](https://tushare.pro/document/2?doc_id=398)
