...
category: 基础数据
type: api
source: https://tushare.pro/document/2?doc_id=262
markdown: https://tushare.pro/wctapi/documents/262.md
updated: 2026-09-15
api: bak_basic
---
...
> **接口：** `bak_basic` · [官方文档](https://tushare.pro/document/2?doc_id=262)
