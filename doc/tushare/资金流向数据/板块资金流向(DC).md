...
category: 资金流向数据
type: api
source: https://tushare.pro/document/2?doc_id=344
markdown: https://tushare.pro/wctapi/documents/344.md
updated: 2026-09-15
...
> **接口：** `moneyflow_ind_dc` · [官方文档](https://tushare.pro/document/2?doc_id=344)
