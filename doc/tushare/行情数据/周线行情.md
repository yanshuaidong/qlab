...
category: 行情数据
type: api
source: https://tushare.pro/document/2?doc_id=144
markdown: https://tushare.pro/wctapi/documents/144.md
updated: 2026-09-15
api: weekly
---
...
> **接口：** `weekly` · [官方文档](https://tushare.pro/document/2?doc_id=144)
