...
category: 行情数据
type: api
source: https://tushare.pro/document/2?doc_id=146
markdown: https://tushare.pro/wctapi/documents/146.md
updated: 2026-09-15
api: pro_bar
---
...
> **接口：** `pro_bar` · [官方文档](https://tushare.pro/document/2?doc_id=146)
