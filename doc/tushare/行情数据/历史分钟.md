...
category: 行情数据
type: api
source: https://tushare.pro/document/2?doc_id=370
markdown: https://tushare.pro/wctapi/documents/370.md
updated: 2026-09-15
api: stk_mins
---
...
> **接口：** `stk_mins` · [官方文档](https://tushare.pro/document/2?doc_id=370)
