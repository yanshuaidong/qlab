...
category: 行情数据
type: api
source: https://tushare.pro/document/2?doc_id=255
markdown: https://tushare.pro/wctapi/documents/255.md
updated: 2026-09-15
api: bak_daily
---
...
> **接口：** `bak_daily` · [官方文档](https://tushare.pro/document/2?doc_id=255)
