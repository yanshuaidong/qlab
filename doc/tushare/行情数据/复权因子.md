...
category: 行情数据
type: api
source: https://tushare.pro/document/2?doc_id=28
markdown: https://tushare.pro/wctapi/documents/28.md
updated: 2026-09-15
api: adj_factor
---
...
> **接口：** `adj_factor` · [官方文档](https://tushare.pro/document/2?doc_id=28)
