...
category: 指数专题
type: api
source: https://tushare.pro/document/2?doc_id=128
markdown: https://tushare.pro/wctapi/documents/128.md
updated: 2026-09-15
...
> **接口：** `index_dailybasic` · [官方文档](https://tushare.pro/document/2?doc_id=128)
...
| pe | float | Y | 市盈率 |
| pe_ttm | float | Y | 市盈率TTM（最新价除以最近4个季度的每股收益） |
| pb | float | Y | 市净率 |
## 接口示例
```python
