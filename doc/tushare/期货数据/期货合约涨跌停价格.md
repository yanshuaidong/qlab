...
category: 期货数据
type: api
source: https://tushare.pro/document/2?doc_id=368
markdown: https://tushare.pro/wctapi/documents/368.md
updated: 2026-09-15
api: ft_limit
---
...
> **接口：** `ft_limit` · [官方文档](https://tushare.pro/document/2?doc_id=368)
