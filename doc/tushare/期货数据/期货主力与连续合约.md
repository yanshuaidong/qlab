...
category: 期货数据
type: api
source: https://tushare.pro/document/2?doc_id=189
markdown: https://tushare.pro/wctapi/documents/189.md
updated: 2026-09-15
api: fut_mapping
---
...
> **接口：** `fut_mapping` · [官方文档](https://tushare.pro/document/2?doc_id=189)
