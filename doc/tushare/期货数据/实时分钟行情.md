...
category: 期货数据
type: api
source: https://tushare.pro/document/2?doc_id=340
markdown: https://tushare.pro/wctapi/documents/340.md
updated: 2026-09-15
api: rt_fut_min
---
...
> **接口：** `rt_fut_min` · [官方文档](https://tushare.pro/document/2?doc_id=340)
