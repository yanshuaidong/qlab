...
category: 期货数据
type: api
source: https://tushare.pro/document/2?doc_id=135
markdown: https://tushare.pro/wctapi/documents/135.md
updated: 2026-09-15
api: fut_basic
---
...
> **接口：** `fut_basic` · [官方文档](https://tushare.pro/document/2?doc_id=135)
