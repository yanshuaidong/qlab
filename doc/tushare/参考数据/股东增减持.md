...
category: 参考数据
type: api
source: https://tushare.pro/document/2?doc_id=175
markdown: https://tushare.pro/wctapi/documents/175.md
updated: 2026-09-15
api: stk_holdertrade
---
...
> **接口：** `stk_holdertrade` · [官方文档](https://tushare.pro/document/2?doc_id=175)
