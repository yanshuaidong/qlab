...
category: 参考数据
type: api
source: https://tushare.pro/document/2?doc_id=124
markdown: https://tushare.pro/wctapi/documents/124.md
updated: 2026-09-15
api: repurchase
---
...
> **接口：** `repurchase` · [官方文档](https://tushare.pro/document/2?doc_id=124)
