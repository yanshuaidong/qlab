...
category: 参考数据
type: api
source: https://tushare.pro/document/2?doc_id=166
markdown: https://tushare.pro/wctapi/documents/166.md
updated: 2026-09-15
...
> **接口：** `stk_holdernumber` · [官方文档](https://tushare.pro/document/2?doc_id=166)
