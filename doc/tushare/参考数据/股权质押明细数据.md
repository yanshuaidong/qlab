...
category: 参考数据
type: api
source: https://tushare.pro/document/2?doc_id=111
markdown: https://tushare.pro/wctapi/documents/111.md
updated: 2026-09-15
api: pledge_detail
---
...
> **接口：** `pledge_detail` · [官方文档](https://tushare.pro/document/2?doc_id=111)
