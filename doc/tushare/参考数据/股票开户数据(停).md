...
category: 参考数据
type: api
source: https://tushare.pro/document/2?doc_id=164
markdown: https://tushare.pro/wctapi/documents/164.md
updated: 2026-09-15
api: stk_account
---
...
> **接口：** `stk_account` · [官方文档](https://tushare.pro/document/2?doc_id=164)
