...
category: 参考数据
type: api
source: https://tushare.pro/document/2?doc_id=62
markdown: https://tushare.pro/wctapi/documents/62.md
updated: 2026-09-15
...
> **接口：** `top10_floatholders` · [官方文档](https://tushare.pro/document/2?doc_id=62)
...
| hold_change | float | 持股变动（0表示不变，空值表示 新进） |
