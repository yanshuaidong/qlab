...
category: 参考数据
type: api
source: https://tushare.pro/document/2?doc_id=110
markdown: https://tushare.pro/wctapi/documents/110.md
updated: 2026-09-15
api: pledge_stat
---
...
> **接口：** `pledge_stat` · [官方文档](https://tushare.pro/document/2?doc_id=110)
