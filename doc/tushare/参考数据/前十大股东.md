...
category: 参考数据
type: api
source: https://tushare.pro/document/2?doc_id=61
markdown: https://tushare.pro/wctapi/documents/61.md
updated: 2026-09-15
api: top10_holders
---
...
> **接口：** `top10_holders` · [官方文档](https://tushare.pro/document/2?doc_id=61)
