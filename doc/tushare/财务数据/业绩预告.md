...
category: 财务数据
type: api
source: https://tushare.pro/document/2?doc_id=45
markdown: https://tushare.pro/wctapi/documents/45.md
updated: 2026-09-15
api: forecast
---
...
> **接口：** `forecast` · [官方文档](https://tushare.pro/document/2?doc_id=45)
...
| p_change_min | float | Y | 预告净利润变动幅度下限（%） |
| p_change_max | float | Y | 预告净利润变动幅度上限（%） |
| net_profit_min | float | Y | 预告净利润下限（万元） |
| net_profit_max | float | Y | 预告净利润上限（万元） |
| last_parent_net | float | Y | 上年同期归属母公司净利润 |
| first_ann_date | str | Y | 首次公告日 |
| summary | str | Y | 业绩预告摘要 |
| change_reason | str | Y | 业绩变动原因 |
## 接口用法
```python
