...
markdown: https://tushare.pro/wctapi/documents/36.md
updated: 2026-09-15
api: balancesheet
---
...
> **接口：** `balancesheet` · [官方文档](https://tushare.pro/document/2?doc_id=36)
...
| comp_type | str | N | 公司类型：1一般工商业 2银行 3保险 4证券 7多元金融 |
## 输出参数
...
| comp_type | str | Y | 公司类型(1一般工商业2银行3保险4证券7多元金融) |
