...
category: 财务数据
type: api
source: https://tushare.pro/document/2?doc_id=103
markdown: https://tushare.pro/wctapi/documents/103.md
updated: 2026-09-15
api: dividend
---
...
> **接口：** `dividend` · [官方文档](https://tushare.pro/document/2?doc_id=103)
...
接口：dividend
描述：分红送股数据
权限：起始时间2000-01-01，单次查询返回2000行，每日20点~21点更新，用户需要至少2000积分才可以调取，具体请参阅[积分获取办法](https://tushare.pro/document/1?doc_id=13)  
## 输入参数
