...
category: 打板专题数据
type: api
source: https://tushare.pro/document/2?doc_id=377
markdown: https://tushare.pro/wctapi/documents/377.md
updated: 2026-09-15
api: tdx_member
---
...
> **接口：** `tdx_member` · [官方文档](https://tushare.pro/document/2?doc_id=377)
