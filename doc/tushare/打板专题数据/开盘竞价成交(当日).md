...
category: 打板专题数据
type: api
source: https://tushare.pro/document/2?doc_id=369
markdown: https://tushare.pro/wctapi/documents/369.md
updated: 2026-09-15
api: stk_auction
---
...
> **接口：** `stk_auction` · [官方文档](https://tushare.pro/document/2?doc_id=369)
...
注：stk_limit中的etf数据已拆分到新的接口etf_limit https://tushare.pro/document/2?doc_id=491
stk_auction中的etf数据已拆分到新的接口 etf_auction https://tushare.pro/document/2?doc_id=493
<br>
<br>
## 输入参数
