...
category: 打板专题数据
type: api
source: https://tushare.pro/document/2?doc_id=376
markdown: https://tushare.pro/wctapi/documents/376.md
updated: 2026-09-15
api: tdx_index
---
...
> **接口：** `tdx_index` · [官方文档](https://tushare.pro/document/2?doc_id=376)
