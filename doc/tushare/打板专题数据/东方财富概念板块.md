...
category: 打板专题数据
type: api
source: https://tushare.pro/document/2?doc_id=362
markdown: https://tushare.pro/wctapi/documents/362.md
updated: 2026-09-15
api: dc_index
---
...
> **接口：** `dc_index` · [官方文档](https://tushare.pro/document/2?doc_id=362)
