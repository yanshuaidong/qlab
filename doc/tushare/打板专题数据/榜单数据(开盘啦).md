...
category: 打板专题数据
type: api
source: https://tushare.pro/document/2?doc_id=347
markdown: https://tushare.pro/wctapi/documents/347.md
updated: 2026-09-15
api: kpl_list
---
...
> **接口：** `kpl_list` · [官方文档](https://tushare.pro/document/2?doc_id=347)

## 开盘啦榜单数据
----

接口：kpl_list
描述：获取涨停、跌停、炸板等榜单数据，交易日8点更新前一个交易日，周六更新周五的数据。
