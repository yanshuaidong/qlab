...
category: 债券专题
type: api
source: https://tushare.pro/document/2?doc_id=392
markdown: https://tushare.pro/wctapi/documents/392.md
updated: 2026-09-15
api: cb_factor_pro
---
...
> **接口：** `cb_factor_pro` · [官方文档](https://tushare.pro/document/2?doc_id=392)
...
积分：8000积分以上每分钟500次，具体请参阅[积分获取办法](https://tushare.pro/document/1?doc_id=13) 
## 输入参数
