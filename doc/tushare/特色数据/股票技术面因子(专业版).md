...
category: 特色数据
type: api
source: https://tushare.pro/document/2?doc_id=328
markdown: https://tushare.pro/wctapi/documents/328.md
updated: 2026-09-15
api: stk_factor_pro
---
...
> **接口：** `stk_factor_pro` · [官方文档](https://tushare.pro/document/2?doc_id=328)
...
| 名称 | 类型 | 必选 | 描述 |
| --- | --- | --- | --- |
| ts_code | str | N | 股票代码ts_code,trade_date至少输入一个参数 |
...
#获取浦发银行某个时段指定输出字段的技术面因子
df = pro.stk_factor_pro(ts_code='600000.SH', start_date='20220501', end_date='20220520', fields='ts_code,trade_date,kdj_qfq,ma_bfq_10,trix_qfq')

```

**数据示例**

      ts_code trade_date   kdj_qfq  ma_bfq_10  trix_qfq
    0   600000.SH   20220520  89.46039      7.934  -0.03885
    1   600000.SH   20220519  69.65618      7.915  -0.04770
    2   600000.SH   20220518  84.76600      7.923  -0.05242
    3   600000.SH   20220517  94.79380      7.931  -0.05994
    4   600000.SH   20220516  84.64891      7.928  -0.06856
    5   600000.SH   20220513  81.87689      7.914  -0.07322
    6   600000.SH   20220512  40.30576      7.896  -0.07502
    7   600000.SH   20220511  32.64022      7.891  -0.06636
    8   600000.SH   20220510  22.09755      7.914  -0.05531
    9   600000.SH   20220509   9.95197      7.936  -0.04263
    10  600000.SH   20220506  29.32056      7.965  -0.02963
    11  600000.SH   20220505  57.15452      7.994  -0.01998
