...
category: 期权数据
type: api
source: https://tushare.pro/document/2?doc_id=159
markdown: https://tushare.pro/wctapi/documents/159.md
updated: 2026-09-15
api: opt_daily
---
...
> **接口：** `opt_daily` · [官方文档](https://tushare.pro/document/2?doc_id=159)
