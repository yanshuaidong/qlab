...
category: 期权数据
type: api
source: https://tushare.pro/document/2?doc_id=158
markdown: https://tushare.pro/wctapi/documents/158.md
updated: 2026-09-15
api: opt_basic
---
...
> **接口：** `opt_basic` · [官方文档](https://tushare.pro/document/2?doc_id=158)
